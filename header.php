          ...
          <div class="row">          
            <div class="<?php if( get_theme_mod( 'ecommerce_solution_cart_enable_disable', true) != '') { ?> col-lg-10 col-md-9 align-self-center"<?php } else { ?>col-lg-12 col-md-12 <?php } ?>">
              <div class="toggle-menu responsive-menu text-start">
                <button role="tab" onclick="ecommerce_solution_menu_open()" class="mobiletoggle"><i class="<?php echo esc_attr(get_theme_mod('ecommerce_solution_responsive_menu_open_icon','fas fa-bars')); ?> p-3"></i><?php echo esc_html( get_theme_mod('ecommerce_solution_open_menu_label', __('Open Menu','ecommerce-solution'))); ?><span class="screen-reader-text"><?php esc_html_e('Open Menu','ecommerce-solution'); ?></span>
                </button>
              </div>
